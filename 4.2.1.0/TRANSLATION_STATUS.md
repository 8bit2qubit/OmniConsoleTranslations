# Translation Status (4.2.1.0)

> 🌐 **English** | [繁體中文](TRANSLATION_STATUS.zh-TW.md)

Auto-migrated from 4.2.0.0: unchanged English keys reuse the previous translation; anything still awaiting a translation is marked `untranslated` and falls back to English until a translator fills it in.

- Total strings (both projects): 623
- Generated: 2026-08-14 21:33:59 +08:00
...
Carried over (never translated) (153):
...
Carried over (never translated) (27):
...
Carried over (never translated) (137):
- `AdvancedSection_Overlay.Text`
- `OverlaySetting_ElevationNote.Text`
- `OverlaySetting_RtssNote.Text`
- `OverlaySetting_RtssStoppedNote.Text`
...
Carried over (never translated) (22):
- `Widget_ControllerLayoutPreset_Custom.Content`
- `Widget_BuiltInMappingNote.Text`
- `Widget_BuiltInMappingProNote.Text`
- `Widget_BuiltInMappingConfirm_Title.Text`
