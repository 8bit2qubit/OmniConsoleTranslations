# Translation Status (4.3.1.0)

> 🌐 **English** | [繁體中文](TRANSLATION_STATUS.zh-TW.md)

Auto-migrated from 4.3.0.0: unchanged English keys reuse the previous translation; anything still awaiting a translation is marked `untranslated` and falls back to English until a translator fills it in.

- Total strings (both projects): 624
- Generated: 2026-08-22 14:31:55 +08:00
...
Carried over (never translated) (28):
...
Carried over (never translated) (23):
- `Widget_OpenFileExplorer`
- `Widget_ControllerLayoutPreset_Custom.Content`
- `Widget_BuiltInMappingNote.Text`
- `Widget_BuiltInMappingProNote.Text`
